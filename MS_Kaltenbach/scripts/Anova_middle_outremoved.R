...
write.csv(middle_summary, file = "data_output/anova/middle_summary_outremoved", row.names = FALSE)    
...
write.csv(species_middle_anova_data, file = "data_output/anova/species_middle_anova_data_outremoved", row.names = FALSE)
