...
licor_middle_df <- read.csv("data_output/Licor/licor_middle")
wp_middle_df <- read.csv("data_output/WP/wp_middle")
...
write.csv(middle_summary_df, file = "data_output/anova/middle_summary", row.names = FALSE)    
...
write.csv(species_middle_anova_data, file = "data_output/anova/anova_middle", row.names = FALSE)
