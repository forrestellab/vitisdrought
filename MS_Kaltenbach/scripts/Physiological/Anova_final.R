...
licor_final_df <- read.csv("data_output/Licor/licor_final")
wp_final_df <- read.csv("data_output/WP/wp_final")
...
write.csv(final_summary_df, file = "data_output/anova/final_summary", row.names = FALSE)    
...
write.csv(species_final_anova_data, file = "data_output/anova/anova_final", row.names = FALSE)
