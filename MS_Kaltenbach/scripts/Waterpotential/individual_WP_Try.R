...
LWP_data<-waterpotentials_gathered%>% # since it took a few days to completely sample all plants, here, they are consolidated to a data point
  ...
  mutate(Date= recode(Date, "11/09" = "11/11"))%>%
  mutate(Date= recode(Date, "11/10" = "11/11"))%>%
  mutate(Date= recode(Date, "11/11" = "11/11"))%>%
  mutate(Date= recode(Date, "11/16" = "11/117"))%>%
  mutate(Date= recode(Date, "11/17" = "11/117"))%>%
  mutate(Date= recode(Date, "12/01" = "12/02"))%>%
  mutate(Date= recode(Date, "12/02" = "12/02"))%>%
  mutate(Date= recode(Date, "12/11" = "12/18"))%>%
  mutate(Date= recode(Date, "12/15" = "12/18"))%>%
  mutate(Date= recode(Date, "12/16" = "12/18"))%>%
  mutate(Date= recode(Date, "12/17" = "12/18"))%>%
  mutate(Date= recode(Date, "12/18" = "12/18"))%>%
