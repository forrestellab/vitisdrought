...
write.csv(beginning_summary_df, file = "data_output/anova/beginning_summary_outremoved_beginning", row.names = FALSE)    
...
write.csv(species_beginning_anova_data, file = "data_output/anova/species_beginning_anova_data_outremoved_1", row.names = FALSE)
