...
write.csv(WP_final, file = "data_output/WP/WP_final", row.names = FALSE)
write.csv(licor_final, file = "data_output/Licor/licor_final", row.names = FALSE)
...
write.csv(WP_middle, file = "data_output/WP/WP_middle", row.names = FALSE)
write.csv(licor_middle, file = "data_output/Licor/licor_middle", row.names = FALSE)
...
write.csv(WP_beginning, file = "data_output/WP/WP_beginning", row.names = FALSE)
write.csv(licor_beginning, file = "data_output/Licor/licor_beginning", row.names = FALSE)
