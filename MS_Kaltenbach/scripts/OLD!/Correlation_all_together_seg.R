...
colnames(combined_df)
                  ...
                  var_pairs  <- list(c("Lat", "Mean_Mesophyll..S.P..volume"),
                                     c("Annual.Mean.Temperature", "Mean_Mesophyll..S.P..volume"),
                                     c("Annual.Precipitation", "Mean_Mesophyll..S.P..volume"),
                                     c("Temperature.Seasonality..standard.deviation..100.", "Mean_Mesophyll..S.P..volume"),
                                     c("Mean.Temperature.of.Coldest.Quarter", "Mean_Mesophyll..S.P..volume"),
                                       
                                     c("Lat", "Mean_mesophyll.volume..S.P.airspace."),
                                     c("Annual.Mean.Temperature",  "Mean_mesophyll.volume..S.P.airspace."), 
                                     c("Annual.Precipitation",  "Mean_mesophyll.volume..S.P.airspace."), 
                                     c("Temperature.Seasonality..standard.deviation..100.",
                                       "Mean_mesophyll.volume..S.P.airspace."), 
                                     c("Mean.Temperature.of.Coldest.Quarter",  "Mean_mesophyll.volume..S.P.airspace."), 
                  ...
                  var_pairs  <- list(c("Lat", "Mean_Mesophyll_S.V.Total.mesophyll.V"), 
                                     c("Annual.Mean.Temperature", "Mean_Mesophyll_S.V.Total.mesophyll.V"), 
                                     c("Annual.Precipitation", "Mean_Mesophyll_S.V.Total.mesophyll.V"), 
                                     c("Temperature.Seasonality..standard.deviation..100.", 
                                       "Mean_Mesophyll_S.V.Total.mesophyll.V"), 
                                     c("Mean.Temperature.of.Coldest.Quarter", "Mean_Mesophyll_S.V.Total.mesophyll.V"), 
                                       
                                     c("Lat", "Mean_Mesophyll_P.V.Total.mesophyll.V"),
                                     c("Annual.Mean.Temperature", "Mean_Mesophyll_P.V.Total.mesophyll.V"),
                                     c("Annual.Precipitation", "Mean_Mesophyll_P.V.Total.mesophyll.V"),
                                     c("Temperature.Seasonality..standard.deviation..100.", 
                                       "Mean_Mesophyll_P.V.Total.mesophyll.V"),
                                     c("Mean.Temperature.of.Coldest.Quarter", "Mean_Mesophyll_P.V.Total.mesophyll.V"),
                                       
                                     c("Lat", "Mean_Mesophyll_SV.Mesophyll_PV"),
                                     c("Annual.Mean.Temperature", "Mean_Mesophyll_SV.Mesophyll_PV"),
                                     c("Annual.Precipitation", "Mean_Mesophyll_SV.Mesophyll_PV"),
                                     c("Temperature.Seasonality..standard.deviation..100.", 
                                       "Mean_Mesophyll_SV.Mesophyll_PV"),
                                     c("Mean.Temperature.of.Coldest.Quarter", "Mean_Mesophyll_SV.Mesophyll_PV"))
...
p_combined <- ggarrange(plotlist = plots_list, ncol = 5, nrow = 3,  common.legend = TRUE, legend = "bottom")
...
# Save Plot
ggsave(paste0("fig_output/Correlations/correlation_D_geoclimate_seg2", ".png"))
ggsave(paste0("fig_output/Correlations/correlation_D_geoclimate_seg2", ".pdf"))
