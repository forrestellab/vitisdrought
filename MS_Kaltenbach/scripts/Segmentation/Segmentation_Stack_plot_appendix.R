...
ggsave("final_plot_star.pdf", final_plot, width = 20, height = 73, units = "cm")
...
final_plot_star_1 <- final_plot + theme(plot.margin = margin(0, 0.0, 0.0, 0.0, "cm"))

ggsave("segmentation_plot_labels_star.pdf", final_plot_star_1, width = 20, height = 73, units = "cm")
